...
describe('test suite: Clothing', () => {
  ...
  it('displays a size chart link in extraInfoHTML', () => {
    expect(clothing.extraInfoHTML()).toContain(`<a href="images/clothing-size-chart.png" target="_blanc">`);
  });
...
describe('test suite: Appliance', () => {
  ...
  beforeEach(() => {
      appliance = new Appliance({
        id: "4e0eccd-8f36-462b-b68a-8182611d9add",
  ...
  it('has the correct properties', () => {
    expect(appliance.id).toEqual('4e0eccd-8f36-462b-b68a-8182611d9add');
  ...
  it('displays instructions and warranty in extraInfoHTML', () => {
    expect(appliance.extraInfoHTML()).toContain(`<a href="images/appliance-instructions.png" target="_blanc">`);
    expect(appliance.extraInfoHTML()).toContain(`Instructions`);
    expect(appliance.extraInfoHTML()).toContain(`<a href="images/appliance-warranty.png" target="_blanc">`);
